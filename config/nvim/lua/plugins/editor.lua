...
return {
    ...
    -- directory is a git repo.
    {
        ...
        keys = {
            ...
            { "<leader>rG", Util.telescope("live_grep", { cwd = false }), desc = "Grep (cwd)" },
        ...
        dependencies = {
            ...
            -- project management
            {
                ...
                keys = {
                    { "<leader>fp", "<Cmd>Telescope workspaces<CR>", desc = "Projects" },
                },
                init = function()
                ...
                opts = {
                    hooks = {
                        open = function()
                            ...
                            if _G.has_neotree then
                                require("neo-tree.command").execute({ action = "show" })
                            end
                        end,
                        open_pre = function()
                            _G.has_neotree = false
                            pcall(function()
                                local state = require("neo-tree.sources.manager").get_state("filesystem", nil, nil)
                                _G.has_neotree = require("neo-tree.ui.renderer").window_exists(state)
                            end)
